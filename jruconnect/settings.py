...
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = '984050199751-68iq7qtemadppgbiftlvs1v02hqhm6o1.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = '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'

LOGIN_URL = 'login'
LOGOUT_URL = 'logout'
LOGIN_REDIRECT_URL = '/google-login-handler/'

LOGOUT_REDIRECT_URL = '/'  # Redirect after logout

SOCIAL_AUTH_LOGIN_ERROR_URL = '/'  # Redirect URL in case of error
